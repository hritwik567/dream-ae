...
class CommandQueue {
   public:
    ...
    Command FinishRFM(); // [RFM] All Bank RFM
   ...
   private:
    ...
    void GetRFMQIndices(const Command& rfm); // [RFM] All Bank RFM
    ...
    // [RFM] related data structures
    std::unordered_set<int> rfm_q_indices_;
    bool is_in_rfm_;
